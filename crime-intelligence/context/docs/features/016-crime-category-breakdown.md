...
## 1. Summary
Show distribution of crime categories. This feature is part of the `Analytics` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused crime category breakdown feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Crime Category Breakdown in a focused, maintainable way.
...
- Support percentage share.
- Support trend comparison.
- Support drill-down into firs.
...
## 6. User Stories
- As a crime analyst, I want to use crime category breakdown so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want crime category breakdown to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for crime category breakdown exactly within the active feature scope.
- Support Category list.
- Support Percentage share.
- Support Trend comparison.
- Support Drill-down into FIRs.
- Support Chart/table views.
- Support Filtering by district and date.
...
- The page or component title should clearly read `Crime Category Breakdown`.
...
- UI should account for category list.
- UI should account for percentage share.
- UI should account for trend comparison.
- UI should account for drill-down into firs.
- UI should account for chart/table views.
...
- Consider data needed for category list.
- Consider data needed for percentage share.
- Consider data needed for trend comparison.
- Consider data needed for drill-down into firs.
- Consider data needed for chart/table views.
...
- Potential route or service function may be added for `crime-category-breakdown` if required by implementation.
...
- Validate inputs related to category list.
- Validate inputs related to percentage share.
- Validate inputs related to trend comparison.
...
- A user with the correct permission can access crime category breakdown.
...
- The implementation supports category list.
- The implementation supports percentage share.
- The implementation supports trend comparison.
- The implementation supports drill-down into firs.
- The implementation supports chart/table views.
...
- Implement Crime Category Breakdown in isolation after reading this spec and the main project docs.
