# Feature 046: Violent Crime Analysis

## 1. Summary
Analyze violent crime categories. This feature is part of the `Domain Analytics` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused violent crime analysis feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Violent Crime Analysis in a focused, maintainable way.
...
## 6. User Stories
- As a crime analyst, I want to use violent crime analysis so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want violent crime analysis to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for violent crime analysis exactly within the active feature scope.
- Support Murder.
- Support Attempt to murder.
- Support Assault.
- Support Riots.
- Support Weapons involved.
- Support Location trends.
- Support Victim protection.
- Support High sensitivity access rules.
...
- The page or component title should clearly read `Violent Crime Analysis`.
...
- UI should account for murder.
- UI should account for attempt to murder.
- UI should account for assault.
- UI should account for riots.
- UI should account for weapons involved.
...
- Consider data needed for murder.
- Consider data needed for attempt to murder.
- Consider data needed for assault.
- Consider data needed for riots.
- Consider data needed for weapons involved.
...
- Potential route or service function may be added for `violent-crime-analysis` if required by implementation.
...
- Validate inputs related to murder.
- Validate inputs related to attempt to murder.
- Validate inputs related to assault.
...
- A user with the correct permission can access violent crime analysis.
...
- The implementation supports murder.
- The implementation supports attempt to murder.
- The implementation supports assault.
- The implementation supports riots.
- The implementation supports weapons involved.
...
## 18. Dependencies
- 008-fir-search
- 051-weapon-involvement-analysis
...
- Implement Violent Crime Analysis in isolation after reading this spec and the main project docs.
