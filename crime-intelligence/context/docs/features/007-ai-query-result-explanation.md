...
## 1. Summary
Explain AI-generated query results in plain language. This feature is part of the `AI Querying` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused ai query result explanation feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver AI Query Result Explanation in a focused, maintainable way.
...
- Support summary explanation.
- Support data source references.
- Support confidence notes.
- Support limitations.
...
## 6. User Stories
- As an investigator, I want to use ai query result explanation so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want ai query result explanation to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for ai query result explanation exactly within the active feature scope.
- Support Summary explanation.
- Support Data source references.
- Support Confidence notes.
- Support Limitations.
- Support Suggested follow-up queries.
- Support Not evidence warning.
...
- The page or component title should clearly read `AI Query Result Explanation`.
...
- UI should account for summary explanation.
- UI should account for data source references.
- UI should account for confidence notes.
- UI should account for limitations.
- UI should account for suggested follow-up queries.
...
- Consider data needed for summary explanation.
- Consider data needed for data source references.
- Consider data needed for confidence notes.
- Consider data needed for limitations.
- Consider data needed for suggested follow-up queries.
...
- Validate inputs related to summary explanation.
- Validate inputs related to data source references.
- Validate inputs related to confidence notes.
...
- A user with the correct permission can access ai query result explanation.
...
- The implementation supports summary explanation.
- The implementation supports data source references.
- The implementation supports confidence notes.
- The implementation supports limitations.
- The implementation supports suggested follow-up queries.
...
- Implement AI Query Result Explanation in isolation after reading this spec and the main project docs.
