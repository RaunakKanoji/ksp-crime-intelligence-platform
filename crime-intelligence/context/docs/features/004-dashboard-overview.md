...
## 1. Summary
Create the main dashboard overview for crime intelligence. This feature is part of the `Dashboard` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused dashboard overview feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Dashboard Overview in a focused, maintainable way.
...
## 6. User Stories
- As an investigator, I want to use dashboard overview so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want dashboard overview to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for dashboard overview exactly within the active feature scope.
- Support Summary cards.
- Support Trend preview.
- Support Map preview.
- Support Recent alerts.
- Support Top crime categories.
- Support District overview.
- Support Pending investigation indicators.
- Support No fake production-like analytics unless sample data is clearly marked.
...
- The page or component title should clearly read `Dashboard Overview`.
...
- UI should account for summary cards.
- UI should account for trend preview.
- UI should account for map preview.
- UI should account for recent alerts.
- UI should account for top crime categories.
...
- Consider data needed for summary cards.
- Consider data needed for trend preview.
- Consider data needed for map preview.
- Consider data needed for recent alerts.
- Consider data needed for top crime categories.
...
- Potential route or service function may be added for `dashboard-overview` if required by implementation.
...
- Validate inputs related to summary cards.
- Validate inputs related to trend preview.
- Validate inputs related to map preview.
...
- A user with the correct permission can access dashboard overview.
...
- The implementation supports summary cards.
- The implementation supports trend preview.
- The implementation supports map preview.
- The implementation supports recent alerts.
- The implementation supports top crime categories.
...
- Implement Dashboard Overview in isolation after reading this spec and the main project docs.
