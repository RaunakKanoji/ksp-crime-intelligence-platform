...
## 1. Summary
Allow users to customize dashboard widgets. This feature is part of the `Dashboard` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused dashboard customization feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Dashboard Customization in a focused, maintainable way.
...
- Support show/hide cards.
- Support reorder sections.
- Support save preferences.
- Support reset default.
...
## 6. User Stories
- As an investigator, I want to use dashboard customization so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want dashboard customization to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for dashboard customization exactly within the active feature scope.
- Support Show/hide cards.
- Support Reorder sections.
- Support Save preferences.
- Support Reset default.
- Support Role-based available widgets.
- Support Simple implementation only.
...
- The page or component title should clearly read `Dashboard Customization`.
...
- UI should account for show/hide cards.
- UI should account for reorder sections.
- UI should account for save preferences.
- UI should account for reset default.
- UI should account for role-based available widgets.
...
- Consider data needed for show/hide cards.
- Consider data needed for reorder sections.
- Consider data needed for save preferences.
- Consider data needed for reset default.
- Consider data needed for role-based available widgets.
...
- Potential route or service function may be added for `dashboard-customization` if required by implementation.
...
- Validate inputs related to show/hide cards.
- Validate inputs related to reorder sections.
- Validate inputs related to save preferences.
...
- A user with the correct permission can access dashboard customization.
...
- The implementation supports show/hide cards.
- The implementation supports reorder sections.
- The implementation supports save preferences.
- The implementation supports reset default.
- The implementation supports role-based available widgets.
...
- Catalyst-first: Store dashboard preferences in Catalyst Data Store per user and role.
- Implement Dashboard Customization in isolation after reading this spec and the main project docs.
