...
## 1. Summary
Identify accused persons linked to multiple FIRs. This feature is part of the `Intelligence` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused repeat offender detection feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Repeat Offender Detection in a focused, maintainable way.
...
- Support matching logic.
- Support identity disambiguation.
- Support fir count.
- Support crime category spread.
...
## 6. User Stories
- As an investigator, I want to use repeat offender detection so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want repeat offender detection to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for repeat offender detection exactly within the active feature scope.
- Support Matching logic.
- Support Identity disambiguation.
- Support FIR count.
- Support Crime category spread.
- Support Location spread.
- Support Time range.
- Support Confidence score.
- Support Human verification requirement.
...
- The page or component title should clearly read `Repeat Offender Detection`.
- Show clear labels, helper text, and safe empty states.
- UI should account for matching logic.
- UI should account for identity disambiguation.
- UI should account for fir count.
- UI should account for crime category spread.
- UI should account for location spread.
...
- Consider data needed for matching logic.
- Consider data needed for identity disambiguation.
- Consider data needed for fir count.
- Consider data needed for crime category spread.
- Consider data needed for location spread.
...
- Potential route or service function may be added for `repeat-offender-detection` if required by implementation.
...
- Validate inputs related to matching logic.
- Validate inputs related to identity disambiguation.
...
- A user with the correct permission can access repeat offender detection.
...
- The implementation supports matching logic.
- The implementation supports identity disambiguation.
- The implementation supports fir count.
- The implementation supports crime category spread.
- The implementation supports location spread.
...
- Implement Repeat Offender Detection in isolation after reading this spec and the main project docs.
