...
## 1. Summary
Show high-level metrics. This feature is part of the `Dashboard` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused crime summary cards feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Crime Summary Cards in a focused, maintainable way.
...
- Support solved cases.
- Support pending cases.
...
## 6. User Stories
- As an investigator, I want to use crime summary cards so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want crime summary cards to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for crime summary cards exactly within the active feature scope.
- Support Total FIRs.
- Support Active cases.
- Support Solved cases.
- Support Pending cases.
- Support Repeat offenders.
- Support High-risk locations.
- Support Crime growth percentage.
...
- The page or component title should clearly read `Crime Summary Cards`.
...
- UI should account for total firs.
- UI should account for active cases.
- UI should account for solved cases.
- UI should account for pending cases.
- UI should account for repeat offenders.
...
- Consider data needed for total firs.
- Consider data needed for active cases.
- Consider data needed for solved cases.
- Consider data needed for pending cases.
- Consider data needed for repeat offenders.
...
- Potential route or service function may be added for `crime-summary-cards` if required by implementation.
...
- Validate inputs related to total firs.
- Validate inputs related to active cases.
- Validate inputs related to solved cases.
...
- A user with the correct permission can access crime summary cards.
...
- The implementation supports total firs.
- The implementation supports active cases.
- The implementation supports solved cases.
- The implementation supports pending cases.
- The implementation supports repeat offenders.
...
- Implement Crime Summary Cards in isolation after reading this spec and the main project docs.
