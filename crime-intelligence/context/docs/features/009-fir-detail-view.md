...
## 1. Summary
Display detailed FIR information. This feature is part of the `FIR Records` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused fir detail view feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver FIR Detail View in a focused, maintainable way.
...
- Support fir metadata.
- Support incident details.
- Support police station.
- Support accused information.
...
## 6. User Stories
- As an investigator, I want to use fir detail view so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want fir detail view to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for fir detail view exactly within the active feature scope.
- Support FIR metadata.
- Support Incident details.
- Support Police station.
- Support Accused information.
- Support Victim information permission-controlled.
- Support Acts and sections.
- Support Case status.
- Support Investigation notes permission-controlled.
- Support Linked cases.
...
- The page or component title should clearly read `FIR Detail View`.
...
- UI should account for fir metadata.
- UI should account for incident details.
- UI should account for police station.
- UI should account for accused information.
- UI should account for victim information permission-controlled.
...
- Consider data needed for fir metadata.
- Consider data needed for incident details.
- Consider data needed for police station.
- Consider data needed for accused information.
- Consider data needed for victim information permission-controlled.
...
- Validate inputs related to fir metadata.
- Validate inputs related to incident details.
- Validate inputs related to police station.
...
- A user with the correct permission can access fir detail view.
...
- The implementation supports fir metadata.
- The implementation supports incident details.
- The implementation supports police station.
- The implementation supports accused information.
- The implementation supports victim information permission-controlled.
...
- Implement FIR Detail View in isolation after reading this spec and the main project docs.
