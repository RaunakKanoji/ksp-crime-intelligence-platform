...
## 1. Summary
Manage standard reference data. This feature is part of the `Data Operations` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused master data management feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Master Data Management in a focused, maintainable way.
...
## 6. User Stories
- As a data officer, I want to use master data management so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want master data management to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for master data management exactly within the active feature scope.
- Support Districts.
- Support Police stations.
- Support Crime categories.
- Support Acts.
...
- The page or component title should clearly read `Master Data Management`.
...
- UI should account for districts.
- UI should account for police stations.
- UI should account for crime categories.
- UI should account for acts.
- UI should account for sections.
...
- Consider data needed for districts.
- Consider data needed for police stations.
- Consider data needed for crime categories.
- Consider data needed for acts.
- Consider data needed for sections.
...
- Validate inputs related to districts.
- Validate inputs related to police stations.
- Validate inputs related to crime categories.
...
- A user with the correct permission can access master data management.
...
- The implementation supports districts.
- The implementation supports police stations.
- The implementation supports crime categories.
- The implementation supports acts.
- The implementation supports sections.
...
- Catalyst-first: Store master reference data in Catalyst Data Store and enforce admin-only updates through Catalyst-backed server logic.
- Implement Master Data Management in isolation after reading this spec and the main project docs.
