...
## 1. Summary
Support hackathon/demo usage with safe sample data. This feature is part of the `Demo` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused demo mode and sample data feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Demo Mode and Sample Data in a focused, maintainable way.
...
- Support demo data rules.
- Support no real sensitive data.
- Support sample firs.
- Support sample users.
...
## 6. User Stories
- As an investigator, I want to use demo mode and sample data so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want demo mode and sample data to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for demo mode and sample data exactly within the active feature scope.
- Support Demo data rules.
- Support No real sensitive data.
- Support Sample FIRs.
- Support Sample users.
- Support Sample districts.
- Support Sample analytics.
- Support Clear demo labels.
- Support Reset demo data option if needed.
...
- The page or component title should clearly read `Demo Mode and Sample Data`.
- Show clear labels, helper text, and safe empty states.
- UI should account for demo data rules.
- UI should account for no real sensitive data.
- UI should account for sample firs.
- UI should account for sample users.
- UI should account for sample districts.
...
- Consider data needed for demo data rules.
- Consider data needed for no real sensitive data.
- Consider data needed for sample firs.
- Consider data needed for sample users.
- Consider data needed for sample districts.
...
- Potential route or service function may be added for `demo-mode-and-sample-data` if required by implementation.
...
- Validate inputs related to demo data rules.
- Validate inputs related to no real sensitive data.
- Validate inputs related to sample firs.
...
- A user with the correct permission can access demo mode and sample data.
...
- The implementation supports demo data rules.
- The implementation supports no real sensitive data.
- The implementation supports sample firs.
- The implementation supports sample users.
- The implementation supports sample districts.
...
- Catalyst-first: Store demo data in Catalyst Data Store and demo files in Catalyst Stratus. Clearly label demo data and keep it separate from real datasets.
- Implement Demo Mode and Sample Data in isolation after reading this spec and the main project docs.
