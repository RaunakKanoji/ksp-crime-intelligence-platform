...
## 1. Summary
Export reports as PDF. This feature is part of the `Reports & Export` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused report export pdf feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Report Export PDF in a focused, maintainable way.
...
## 6. User Stories
- As a crime analyst, I want to use report export pdf so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want report export pdf to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for report export pdf exactly within the active feature scope.
- Support Report layout.
- Support Header.
- Support Filters used.
- Support Charts.
- Support Tables.
- Support Generated timestamp.
- Support User who generated it.
- Support Security footer.
- Support Export permission check.
...
- The page or component title should clearly read `Report Export PDF`.
...
- UI should account for report layout.
- UI should account for header.
- UI should account for filters used.
- UI should account for charts.
- UI should account for tables.
...
- Consider data needed for report layout.
- Consider data needed for header.
- Consider data needed for filters used.
- Consider data needed for charts.
- Consider data needed for tables.
...
- Validate inputs related to report layout.
- Validate inputs related to header.
- Validate inputs related to filters used.
...
- A user with the correct permission can access report export pdf.
...
- The implementation supports report layout.
- The implementation supports header.
- The implementation supports filters used.
- The implementation supports charts.
- The implementation supports tables.
...
- Catalyst-first: Use Catalyst server-side logic to generate the PDF if feasible, store generated files in Catalyst Stratus, and write export audit logs to Catalyst Data Store.
- Implement Report Export PDF in isolation after reading this spec and the main project docs.
