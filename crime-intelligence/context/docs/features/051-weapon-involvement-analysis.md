# Feature 051: Weapon Involvement Analysis

## 1. Summary
Analyze cases involving weapons. This feature is part of the `Domain Analytics` group and must be implemented only when it is the active feature. It helps the KSP Crime Intelligence web app support secure, explainable, and progressive crime intelligence workflows without turning the project into a multi-app or mobile implementation.

## 2. Problem
Current crime analysis workflows can be fragmented, manual, and dependent on spreadsheet-heavy processes. Without a focused weapon involvement analysis feature, users may lack a reliable way to perform this workflow with proper security, data context, permission controls, and auditability.
...
## 4. Goals
- Deliver Weapon Involvement Analysis in a focused, maintainable way.
...
- Support weapon type.
- Support crime category.
- Support location pattern.
- Support repeat accused.
...
## 6. User Stories
- As a crime analyst, I want to use weapon involvement analysis so that I can complete my crime-intelligence task without switching to manual spreadsheets.
...
- As an admin/security reviewer, I want weapon involvement analysis to respect permissions and audit requirements so that sensitive crime data remains protected.

## 7. Functional Requirements
- Provide the core workflow for weapon involvement analysis exactly within the active feature scope.
- Support Weapon type.
- Support Crime category.
- Support Location pattern.
- Support Repeat accused.
- Support Violent crime linkage.
- Support Evidence linkage if available.
...
- The page or component title should clearly read `Weapon Involvement Analysis`.
...
- UI should account for weapon type.
- UI should account for crime category.
- UI should account for location pattern.
- UI should account for repeat accused.
- UI should account for violent crime linkage.
...
- Consider data needed for weapon type.
- Consider data needed for crime category.
- Consider data needed for location pattern.
- Consider data needed for repeat accused.
- Consider data needed for violent crime linkage.
...
- Potential route or service function may be added for `weapon-involvement-analysis` if required by implementation.
...
- Validate inputs related to weapon type.
- Validate inputs related to crime category.
- Validate inputs related to location pattern.
...
- A user with the correct permission can access weapon involvement analysis.
...
- The implementation supports weapon type.
- The implementation supports crime category.
- The implementation supports location pattern.
- The implementation supports repeat accused.
- The implementation supports violent crime linkage.
...
- Implement Weapon Involvement Analysis in isolation after reading this spec and the main project docs.
